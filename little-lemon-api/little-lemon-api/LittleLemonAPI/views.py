...
class ManagersListView(generics.ListCreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not username:
            return Response(status=400, data={"error": "Username is required"})
...
class CartOperationsView(generics.ListCreateAPIView):
    ...
    def delete(self, request, *arg, **kwargs):
        if request.data["menuitem"]:
            ...
            return JsonResponse(
                status=201, data={"message": "All Items removed from cart"}
            )
...
class OrderOperationsView(generics.ListCreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return JsonResponse(
            status=201,
            data={
                "message": "Your order has been placed! Your order number is {}".format(
                    str(order.id)
                )
            },
        )
...
class SingleOrderView(generics.ListCreateAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        order.delete()
        return JsonResponse(
            status=200, data={"message": "Order #{} was deleted".format(order_number)}
        )
